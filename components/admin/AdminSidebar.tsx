...
export default function AdminSidebar() {
    ...
    return (
        <>
            ...
            {/* Sidebar */}
            <aside
                className={`fixed top-0 left-0 z-50 h-full w-72 bg-background-light dark:bg-[#221c10] border-r border-black/10 dark:border-white/10 shadow-2xl transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full'
                    }`}
            >
