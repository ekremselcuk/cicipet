      ...
      <section className="w-full overflow-hidden px-4">
        <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden shadow-lg group">
          <div className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-105"
            data-alt="Close up of a cute cat looking at the camera"
            style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuBcoxQt5YAPUPl6OswTEcHXPIijjDl7uIBKMQ6TyPiLdLNoXx-8IOKavXND-4hXd_qmOaZV2dHLZi1NUABkAA0L_dLMTNF-ERccXR36ywHRAdyRaiCaIo7NO8igLnnfUlkoArdqel51J8a3hpiVh9-XeBdyn1nokJusf58SJrQm7n6OEDWSc88TR47JYNUB6S0xK9lrXZMA466A-PMg2EXvH_SIqwWrtZq2CoZpDgMp8qNAexR2fs8sUNlR2-pUOzabMWOKtpFIYkM')" }}>
          </div>
          ...
          <div className="absolute bottom-0 left-0 w-full p-5 flex flex-col items-start gap-2">
            <div className="flex items-center gap-2 mb-1">
              ...
              <div
                ...
                <span className="text-white text-[10px] font-medium">Son 2 gün</span>
              </div>
            </div>
            <h2 className="text-white text-xl font-bold leading-tight shadow-sm">Haftanın Gözdesi: <br />Boncuk 🏆
            </h2>
            <p className="text-white/90 text-xs font-medium line-clamp-1 max-w-[85%]">En tatlı uyku pozu için oy
              ver!</p>
            <button
