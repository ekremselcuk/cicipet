        ...
        <div className="min-h-screen bg-background-light dark:bg-background-dark pb-24">
            ...
            <main className="p-4">
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                    ...
                    {/* Pet Name input added as per request */}
                    <div className="space-y-1">
                        <label className="text-sm font-medium text-slate-700 dark:text-gray-300 ml-1">Pet İsmi <span className="text-green-500">*</span></label>
                        <input
                            type="text"
                            required
                            value={formData.name}
