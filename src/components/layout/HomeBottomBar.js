    ...
    return (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 w-[90%] max-w-[448px] z-50 bg-white/90 backdrop-blur-2xl border border-white/40 shadow-floating rounded-[35px] px-2 py-2 flex justify-between items-center h-16">
            ...
            <div className="relative flex-1 flex justify-center">
                <Link href="/upload" className="w-14 h-14 rounded-full bg-gradient-to-tr from-paw-orange to-red-500 flex items-center justify-center shadow-lg shadow-orange-200 border-[4px] border-[#f8f9fa] transform transition-transform hover:scale-105 active:scale-95 group">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="text-white drop-shadow-md group-hover:rotate-12 transition-transform duration-300">
