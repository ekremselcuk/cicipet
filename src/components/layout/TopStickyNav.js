...
export default function TopStickyNav() {
    ...
    return (
        <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur-md shadow-sm border-b border-gray-100 h-16 px-4 flex justify-between items-center transition-all">
            {/* Left: Logo & Slogan */}
            <div
            ...
            >
                <div className="flex items-center gap-1">
                    ...
                    <span className="font-black text-xl text-orange-500 tracking-tight">CiciPet</span>
                </div>
